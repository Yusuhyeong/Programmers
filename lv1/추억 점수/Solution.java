...
public class Solution {
	public static void main(String[] args) {
		String[] testcaseA = {"may", "kein", "kain", "radi"};
		int[] testcaseB = {5, 10, 1, 3};
		String[][] testcaseC = {{"may", "kein", "kain", "radi"}, {"may", "kein", "brin", "deny"}, {"kon", "kain", "may", "coni"}};
		Solution solution = new Solution();
		System.out.println(Arrays.toString(solution(testcaseA, testcaseB, testcaseC)));
	}
